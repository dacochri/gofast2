class Skid < ActiveRecord::Base
  ...
  attr_accessible :delivery_location, :delivery_time, :oversized, :pickup_location, :pickup_time, :product_desc, :shipment_id, :warehouse_delivery_time, :warehouse_pickup_time, :weight, :unit

  message = ValidationValues.message

  validates :delivery_location, :delivery_time, :pickup_location, :pickup_time, :product_desc, :shipment_id, :warehouse_delivery_time, :warehouse_pickup_time, :weight, :unit, :presence => true
  validates :shipment_id, :oversized, :numericality => true
