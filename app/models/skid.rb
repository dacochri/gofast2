class Skid < ActiveRecord::Base
  ...
  validates :delivery_location, :delivery_time, :pickup_location, :pickup_time, :product_desc, :shipment_id, :skid_count, :warehouse_delivery_time, :warehouse_pickup_time, :weight, :presence => true
